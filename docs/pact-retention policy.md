...
Note that **10 versions** and **90 days** used in the examples below are set as environment variables in wrangler json file.
...
- **Recent**: updated within the last **90 days**.
...
For each **provider/consumer pair**, retain **all** pact versions updated in the last **90 days**, even if this results in retaining more than 10 versions.

### R3: Deletion rule for older pacts

A pact entry **may be deleted** only when **all** of the following are true:

1. The pact entry was updated **more than 90 days ago**, **and**
...
- Keep everything “recent” (updated < 90 days), regardless of rank.
...
- Among the 5 older-than-top-10 entries:
  - If any were updated within the last 90 days, they are retained.
  - Any that are older than 90 days and have at least 10 newer versions may be deleted.
